...
- Example:
  ...
  - France in 2026: marginal corporate tax rate = 25% $\Rightarrow$
    interest expenses are deductible up to the higher of EUR 3 million
    or 30% of EBITDA.

  - US in 2026: marginal corporate tax rate (federal rate) = 21%
...
- Present value of the tax shield is:
  $$PV\left(\operatorname{Tax \ shield}\right) = \sum_{i = 1}^{\infty} \frac{\tau_{C}r D}{\left(1+r\right)^{i}} = \frac{\tau_{C}r D}{1+r} + \frac{\tau_{C}r D}{\left(1+r\right)^{2}} + \frac{\tau_{C}r D}{\left(1+r\right)^{3}} + \dots$$

  - The same saving $\tau_{C} r D$ every year, discounted one year further
    each time. Summing this perpetuity gives
    $$PV\left(\operatorname{Tax \ shield}\right) = \frac{\tau_{C}r D}{r} = \tau_{C} D.$$
...
## Do firms prefer debt? {.smaller}

Net External Financing and Capital Expenditures by U.S. Corporations,
1980-2021

::: {.center}
![](NetExternalFinancingUSCorporations.png){fig-align="center" height="330"}
:::
